...
<div class="main-contdent" >
    <div>
        <div  style="position: fixed;width: 100%;top: 0" id="btn_print" >
            <center>
                <a class="btn btn-lg btn-warning-alt text-white" href = '<?php echo base_url(); ?>report/transfer_list'  style="width:5%"><span class="fa fa-chevron-left"></span></a>
                ...
                <tbody>
                    <?php 
                        ...
                        foreach($report AS $r){ 
                            ...
                            }else if(($r['accountability_id']==0 || $r['accountability_id']!=0) && $r['change_location']==1){

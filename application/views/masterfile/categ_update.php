            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>masterfile/categ_list/">Category List</a></li>
                    ...
                    <div class="card-body">                        
                        <div class="col-lg-6 offset-lg-3">
                            <div class="card bor-radius shadow">
                                ...
                                <form action="<?php echo base_url(); ?>masterfile/update_category" method="POST" novalidate="novalidate">
